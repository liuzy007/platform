...
public class BoundedConcurrentHashMapPerformanceTestAllWriteNoCache {
	...
	private static void test(final int entities, final int concurrent) {
		...
		final BoundedConcurrentHashMap<String, String> map = new BoundedConcurrentHashMap<String, String>(1);
