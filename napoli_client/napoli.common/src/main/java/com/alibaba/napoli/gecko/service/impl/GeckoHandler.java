...
import com.alibaba.napoli.gecko.core.nio.NioSession;
import com.alibaba.napoli.gecko.core.nio.impl.TimerRef;
import com.alibaba.napoli.gecko.core.util.ExceptionMonitor;
...
import com.alibaba.napoli.gecko.service.RemotingServer;
...
import com.alibaba.napoli.gecko.service.exception.IllegalMessageException;
...
public class GeckoHandler implements Handler {
    ...
    protected void processResponse(final Object message, final DefaultConnection defaultConnection) {
    ...
    protected <T extends RequestCommand> void processRequest(final Session session, final Object message,
            final DefaultConnection defaultConnection) {
