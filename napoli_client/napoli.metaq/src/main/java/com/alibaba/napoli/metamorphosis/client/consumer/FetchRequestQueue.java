...
class FetchRequestQueue {
	...
	public List<TopicPartitionRegInfo> getTopicPartitionRegInfos(){
		List<TopicPartitionRegInfo> topicPartitionRegInfos = new ArrayList<TopicPartitionRegInfo>();
		for(FetchRequest request:queue){
			topicPartitionRegInfos.add(request.getTopicPartitionRegInfo());
		}
		return topicPartitionRegInfos;
	}
