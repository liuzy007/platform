...
public class ConsumerConfig extends MetaClientConfig {
	 ...
	 */
	public void setMaxIncreaseFetchDataRetries(
			final int maxFetchRetriesForDataNotEnough) {
	 ...
	 */
	@Deprecated
	public void setMaxDelayFetchTimeWhenExceptionInMills(
			final long maxDelayFetchTimeWhenExceptionInMills) {
	...
	public void setCommitOffsetPeriodInMills(
			final long commitOffsetPeriodInMills) {
	 ...
	 */
	public void setLoadBalanceStrategyType(
			final LoadBalanceStrategy.Type loadBalanceStrategyType) {
