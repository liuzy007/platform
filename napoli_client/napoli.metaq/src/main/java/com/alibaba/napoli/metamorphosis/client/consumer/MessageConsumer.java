...
public interface MessageConsumer extends Shutdownable {
	 ...
	 */
	public MessageIterator get(String topic, Partition partition, long offset,
			int maxSize) throws MetaClientException, InterruptedException;
	 ...
	 *            消息监听器
	 */
	public MessageConsumer subscribe(String topic, int maxSize,
			MessageListener messageListener) throws MetaClientException;
