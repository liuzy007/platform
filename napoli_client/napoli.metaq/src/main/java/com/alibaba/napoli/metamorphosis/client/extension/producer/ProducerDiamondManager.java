...
import com.alibaba.napoli.metamorphosis.utils.DiamondUtils;
...
public class ProducerDiamondManager {
	...
	private final Map<String/* topic */, List<Partition>> partitionsMap = new ConcurrentHashMap<String, List<Partition>>();
	...
	public ProducerDiamondManager(final MetaClientConfig metaClientConfig) {
		...
		//
		// });
		DiamondUtils.getPartitions(metaClientConfig.getPartitionsInfo(),
				this.partitionsMap);
	}
