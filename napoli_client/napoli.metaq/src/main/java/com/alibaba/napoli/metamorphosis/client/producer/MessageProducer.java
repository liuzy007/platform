...
import com.alibaba.napoli.metamorphosis.client.Shutdownable;
...
public interface MessageProducer extends Shutdownable {
	 ...
	 *             响应中断
	 */
	public SendResult sendMessage(Message message) throws MetaClientException,
	 ...
	 * @since 1.4
	 */
	public void sendMessage(Message message, SendMessageCallback cb, long time,
			TimeUnit unit);
	 ...
	 *             响应中断
	 */
	public SendResult sendMessage(Message message, long timeout, TimeUnit unit)
