 ...
 */
package com.alibaba.napoli.metamorphosis.client.extension.storage;
...
import com.alibaba.napoli.common.store.journal.IndexMap;
...
public class MessageStore extends JournalStore {
	...
	static class MessageIndexMap implements IndexMap {
		...
		public Iterator<BytesKey> keyIterator() {
			this.lock.lock();
			try {
				return new MessageIndexMapItreator(new LinkedHashSet<BytesKey>(
				...
				try {
					if (this.currentKey == null) {
						throw new IllegalStateException(
								"The next method is not been called");
					}
