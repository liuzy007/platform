...
public class Operator {
	...
	public Operator(final int operation, final Object oper1,
			final Object oper2, final Object oper3) {
	...
	public String print(final String level) {
		String st = level + operation + ":"
				+ Operator.operationString(operation) + "(\n";
	...
	Object equal() throws Exception {
		...
		case LONG:
			...
			if (class2 == Operator.LONG) {
				return Boolean
						.valueOf(((Number) arg1).longValue() == ((Number) arg2)
								.longValue());
			}
		...
		case DOUBLE:
			...
			if (class2 == Operator.LONG) {
				return Boolean
						.valueOf(((Number) arg1).doubleValue() == ((Number) arg2)
								.longValue());
			}
			if (class2 == Operator.DOUBLE) {
				return Boolean
	 ...
	 * 
	 * @param not
	 *            true if this is a NOT LIKE construct, false if this is a LIKE
	 *            construct.
	 * @param use_escape
	 *            true if this is a LIKE ESCAPE construct, false if there is no
	 *            ESCAPE clause
	...
	public void throwBadObjectException(final Class class1) throws Exception {
		throw new Exception("Bad Object: '" + class1.getName()
				+ "' for operation: " + toString());
	}

	public void throwBadObjectException(final int class1) throws Exception {
		throw new Exception("Bad Object: '" + Operator.getClassName(class1)
				+ "' for operation: " + toString());
	}

	public void throwBadObjectException(final int class1, final int class2)
			throws Exception {
		throw new Exception("Bad Object: expected '"
				+ Operator.getClassName(class1) + "' got '"
				+ Operator.getClassName(class2) + "' for operation: "
				+ toString());
	}
