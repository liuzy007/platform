...
public class ZkUtils {
	 ...
	 * @throws Exception
	 */
	public static void createPersistentPath(final ZkClient client,
			final String path, final String data) throws Exception {
		try {
	...
	public static void createEphemeralPathExpectConflict(final ZkClient client,
		...
		try {
			...
			if (storedData == null || !storedData.equals(data)) {
				...
				logger.info(path + " exists with value " + data
	...
	public static String readDataMaybeNull(final ZkClient client,
			final String path) {
