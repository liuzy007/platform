...
public class MetaZookeeper {
    ...
    public final String infoTopicsPath;
    public final String infoUrgentMessagesPath;
    ...
    public MetaZookeeper(final ZkClient zkClient, final String root) {
        ...
        this.infoTopicsPath = this.metaRoot +"/info/topics";
        this.infoUrgentMessagesPath = this.metaRoot+"/info/urgent_messages";
    }
    ...
    public class ZKTopicRightDirs{
    	public ZKTopicRightDirs(final String topic){
    		this.infoTopicRightDir = MetaZookeeper.this.infoTopicsPath+"/"+topic;
    		this.infoTopicReadRightDir = this.infoTopicRightDir+"/r";
    		this.infoTopicWriteRightDir = this.infoTopicRightDir+"/w";
    	}
    	public String infoTopicRightDir;
    	public String infoTopicReadRightDir;
    	public String infoTopicWriteRightDir;
    }

    
    public class ZKTopicBorkerRightDirs extends ZKTopicRightDirs{
    	public ZKTopicBorkerRightDirs(final String topic,int brokerId){
    		super(topic);
    		infoTopicBrokerReadRightDir = super.infoTopicReadRightDir+"/"+brokerId;
    		infoTopicBrokerWriteRightDir = super.infoTopicWriteRightDir+"/"+brokerId;
    	}
    	
    	public String infoTopicBrokerReadRightDir;
    	public String infoTopicBrokerWriteRightDir;
