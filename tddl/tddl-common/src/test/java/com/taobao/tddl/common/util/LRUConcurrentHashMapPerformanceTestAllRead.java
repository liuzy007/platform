...
//
//public class LRUConcurrentHashMapPerformanceTestAllRead {
//
...
//		
//		final LRUConcurrentHashMap<String, String> map = new LRUConcurrentHashMap<String, String>(1000);
...
//								if(first) {
//									System.out.println("first: "+errorCount.get());
//									first = false;
//								}
//							}
